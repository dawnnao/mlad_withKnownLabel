...
for c = 3 % 1 : size(out.testF1Mean{4}, 2)
    meanData = [meanData, out.testF1Mean{1}(:, c), out.testF1Mean{5}(:, c), out.testF1Mean{4}(:, c), out.testF1Mean{8}(:, c)];
end
meanData = meanData';
...
saveas(gcf, [sumFolder 'barPlot_stage3_test_mean_F1_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.fig'])
saveas(gcf, [sumFolder 'barPlot_stage3_test_mean_F1_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.tif'])
saveas(gcf, [sumFolder 'barPlot_stage3_test_mean_F1_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.emf'])
...
saveas(gcf, [sumFolder 'barPlot_stage3_test_mean_Recall_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.tif'])
saveas(gcf, [sumFolder 'barPlot_stage3_test_mean_Recall_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.emf'])
...
saveas(gcf, [sumFolder 'barPlot_stage3_test_mean_Precision_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.tif'])
saveas(gcf, [sumFolder 'barPlot_stage3_test_mean_Precision_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.emf'])
