function sensor = mlad110(readRoot, saveRoot, sensorNum, dateStart, dateEnd, k, sensorTrainRatio, sensorPSize, fs, step, labelName)
% DESCRIPTION:
...
%             end
    ...
    while sTemp > 0
        ...
        for m = cTemp
            ...
            [trainSet.label, count] = dispAndLabel(trainSet.data, trainSet.label, ...
...
% ask go on or stop
head = 'Continue to step3, automatically train deep neural network now?';
