function sensor = mlad101(readRoot, saveRoot, sensorNum, dateStart, dateEnd, k, sensorTrainRatio, sensorPSize, fs, step, labelName)
% DESCRIPTION:
...
while goNext == 0
    ...
    for g = 1 : groupTotal
        for s = sensor.num{g}
            sensor.image{s} = sensor.image{s}(1:10000, :); % just time domain plot
        end
    end
