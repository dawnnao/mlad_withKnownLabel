...
saveRoot = 'D:/results/results_mlad_withKnownLabel/spectrogram_and_tf/mlad111/';
...
for sensorTrainRatio = 0.03 % : 0.01 : 0.03
    for seed = 1 % 2 : 5
        sensor = mlad111_withKnownLabel_spectrogram_and_tf(readRoot, saveRoot, sensorNum, dateStart, dateEnd, ...
