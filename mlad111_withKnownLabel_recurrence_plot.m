function sensor = mlad111_withKnownLabel_recurrence_plot(readRoot, saveRoot, sensorNum, ...
...
%                    label2012.image{n}(80001:90000, m) = single(img9(:));
                   label2012.image{n}(1:10000, m) = single(img9(:));
...
%                    label2012.image{n}(90001:100000, m) = single(img10(:));
                   label2012.image{n}(10001:20000, m) = single(img10(:));
...
%                    label2012.image{n}(100001:110000, m) = single(img11(:));
                   label2012.image{n}(20001:30000, m) = single(img11(:));
...
for g = 1 : groupTotal
    ...
    feature{g}.image = reshape(feature{g}.image, [100, 100, 3, numTemp]);
...
[labelTempNeural, countTempNeural, dateVec, dateSerial] = ...
    classifierMultiInTimeFreq_spectrogram_recurrence_plot(readRoot, sensor.numVec, date.serial.start, date.serial.end, ...
