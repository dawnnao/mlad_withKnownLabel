 function sensor = mvad_withKnownLabel(readRoot, saveRoot, sensorNum, dateStart, dateEnd, sensorTrainRatio, sensorPSize, step, labelName, seed, maxEpoch, publicImagesetPath, labelPath)
% DESCRIPTION:
