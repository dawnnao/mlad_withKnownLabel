function [label, labelCount, dateVec, dateSerial, labelDecimal] = classifierMultiInTime_fromRAM(pathRead, ...
...
%                 set(gcf, 'visible', 'on');
                ...
                labelDecimal{s}(:, count) = neuralNet{s}(img(:)); % temp for roc plot
