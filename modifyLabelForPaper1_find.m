...
load('C:\Users\Owner\Documents\GitHub\mlad\trainingSet_justLabel_inSensorCell_toChannel3-absIdx8302.mat')
...
for s = 1 : 38
    ...
    while count <= length(idx)
        ...
        elseif classify == 909
            ...
            fprintf('9 for jumping to the next 50th, 909 for saving current progress.\n')
        end
        fprintf('-----------------------------------\n')
