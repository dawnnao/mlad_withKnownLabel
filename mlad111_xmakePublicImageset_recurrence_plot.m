function sensor = mlad111_xmakePublicImageset_recurrence_plot(readRoot, saveRoot, sensorNum, dateStart, dateEnd, k, sensorClustRatio, sensorPSize, fs, step, labelName)
% DESCRIPTION:
...
%         [~, sensor.date.vec, sensor.date.serial] = ...
        [~, sensor.date.vec{s}, sensor.date.serial{s}] = ...
            glanceInTimeFreqMulti_recurrence_plot(readRoot, sensor.num{g}, date.serial.start, date.serial.end, dirName.all, '0-all_', fs);
