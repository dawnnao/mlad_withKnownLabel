...
saveRoot = 'C:/results/results_mlad_withKnownLabel/publicImageset_recurrence_plot/';
...
sensor = mlad111_xmakePublicImageset_recurrence_plot(readRoot, saveRoot, sensorNum, dateStart, dateEnd, k, sensorTrainRatio, sensorPSize, fs, step, []);
