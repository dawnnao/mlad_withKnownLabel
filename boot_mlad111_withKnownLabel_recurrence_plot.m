...
saveRoot = 'D:/results/results_mlad_withKnownLabel/recurrence_plot/mlad111/';
...
sizeFilter = [40];
numFilter = [20];
publicImagesetPath = 'C:/results/results_mlad_withKnownLabel/publicImageset_recurrence_plot/2012-01-01--2012-12-31_sensor_1-38_fusion/';
...
for sensorTrainRatio = 0.03 % : 0.01 : 0.03
    for seed = 1 % 2 : 5
        sensor = mlad111_withKnownLabel_recurrence_plot(readRoot, saveRoot, sensorNum, dateStart, dateEnd, ...
