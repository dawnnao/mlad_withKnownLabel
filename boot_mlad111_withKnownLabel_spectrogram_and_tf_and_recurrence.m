...
saveRoot = 'D:/results/results_mlad_withKnownLabel/spectrogram_and_tf_and_recurrence_plot/mlad111/';
...
for sensorTrainRatio = 0.03 % : 0.01 : 0.03
    for seed = 1 % 2 : 5
        sensor = mlad111_withKnownLabel_spectrogram_and_tf_and_recurrence_plot(readRoot, saveRoot, sensorNum, dateStart, dateEnd, ...
