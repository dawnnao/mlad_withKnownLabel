...
for c = 3 % 1 : size(out.valiF1Mean{4}, 2)
    meanData = [meanData, out.valiF1Mean{1}(:, c), out.valiF1Mean{5}(:, c), out.valiF1Mean{4}(:, c), out.valiF1Mean{8}(:, c)];
end
meanData = meanData';
...
% 
% saveas(gcf, [sumFolder 'barPlot_stage2_vali_mean_F1_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.fig'])
% saveas(gcf, [sumFolder 'barPlot_stage2_vali_mean_F1_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.tif'])
% saveas(gcf, [sumFolder 'barPlot_stage2_vali_mean_F1_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.emf'])
...
saveas(gcf, [sumFolder 'barPlot_stage2_vali_mean_Recall_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.tif'])
saveas(gcf, [sumFolder 'barPlot_stage2_vali_mean_Recall_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.emf'])
...
saveas(gcf, [sumFolder 'barPlot_stage2_vali_mean_Precision_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.tif'])
saveas(gcf, [sumFolder 'barPlot_stage2_vali_mean_Precision_' datestr(now,'yyyy-mm-dd_HH-MM-SS') '.emf'])
