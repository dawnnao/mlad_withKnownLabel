...
saveRoot = 'D:/results/results_mlad_withKnownLabel/mlad011/';
...
for sensorTrainRatio = 0.01 : 0.01 : 0.03
    for seed = 1 : 10
        sensor = mlad011_withKnownLabel(readRoot, saveRoot, sensorNum, dateStart, dateEnd, ...
            sensorTrainRatio, sensorPSize, fs, step, [], seed, maxEpoch, batchSize, publicImagesetPath, labelPath);
    end
end
